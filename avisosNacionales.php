    ...
    <main>
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="row mt-4">
                        <div class="titulosPrincipal font-weight-bold col-sm-12 text-left">Mapa actual del paso de
                            frentes por España y Europa</div>
                        <div><img class="contenedorImagen img-fluid d-block pr-5 ml-3 mb-5 mt-1" src="../media/images/avisos.png">
                        </div>
                    </div>
