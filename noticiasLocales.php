    ...
    <main>
        <div class="container-fluid p-0">
                                    ...
                                    <div class="col-1 p-1">
                                        ...
                                        <a href="#a<?php echo $numeroModal;?>" data-toggle="modal"
                                            data-target="#noticia_<?php echo $numeroModal;?>"><button
                                                data-toggle="tooltip" title="Eliminar" class="btn"><spam class="sr-only">add</spam>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="titulosPrincipal font-weight-bold text-center">Añadir noticia
                                                <a href="noticiasNueva.php"><button alt="add" value="add" class="btn" data-toggle="tooltip"
                                                        title="Añadir"><i class="far fa-plus-square"></i><spam class="sr-only">add</spam></button></a>
                                            </div>
                                        </div>
                                        <?php 
                                        }else{
            ...
            <div class="text-center">
                ...
                <a href="noticiasNueva.php"><button class="btn"><i class="far fa-plus-square" data-toggle="tooltip"
                            title="Añadir"></i></button></a>
            </div>
            <?php
            }
