const application = {
  ...
  const tomTom = {
    key: 'lRyGqXERlV3LduMPWzp6t5XJ9wzNMM7r',
    mapPadding: 40,
    map: null,
    popup: null,
    searchZoom: 8
  ...
  function init() {
    ...
    //Con el setInterval conseguimos que la página se recargue y se cargue el Layer
    var x = 0;
    var intervalID = setInterval(function () {
       ...
       if (++x === 6) {
         //pasadas 3 recargas, se limpiará y parará
  ...
  function updateLayer() {
    ...
    var contract = params.get('a');
    openWeatherMap.layer = contract;
